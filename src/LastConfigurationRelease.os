...
Функция ПолучитьИнформацию(ДанныеКонфигурации) Экспорт
	...
	Шаблон = "/ipp/ITSREPV/V8Update/Configs/%1/%2/%3/%4";
	СтрокаЗапроса = СтрШаблон(Шаблон, ДанныеКонфигурации.Тип, ДанныеКонфигурации.Версия, ДанныеКонфигурации.ВерсияПлатформы, "UpdInfo.txt");
	...
	Для А = 0 По КолСтрок Цикл
		...
		Если ПозицияРавно <> 0 Тогда
			...
			СтруктураРелиза.Вставить(КартаКлючей.Получить(Ключ), СокрЛП(Сред(Стр,ПозицияРавно + 1)));	
		КонецЕсли;
